                ...
                {addedPhotos.length > 0 && (
                    addedPhotos.map(link => (
                        <div key={link} className="relative h-32 flex">
                            <img className="rounded-2xl object-cover position-center w-full" src={BASE_URL + '/uploads/' + link} alt="photo"/>
                            ...
                            <button onClick={(e) => mainPhoto(e, link)} className="absolute bottom-1 left-1 text-white bg-black bg-opacity-50 rounded-2xl py-2 px-3 cursor-pointer">
                                {link === addedPhotos[0] ? (
